/** BSB state-stream protobuf schema, extracted from the official @busy-app/busy-lib worker bundle (v0.17.0). */
export const BSB_SCHEMA = {
  "nested": {
    "BSB_State": {
      "nested": {
        "StateUpdate": {
          ...
          "fields": {
            "deviceName": {
              "type": "BSB_State.DeviceName",
              "id": 1
            },
            "power": {
              "type": "BSB_State.Power",
              "id": 2
            },
            "brightness": {
              "type": "BSB_State.Brightness",
              "id": 3
            },
            "audioVolume": {
              "type": "BSB_State.AudioVolume",
              "id": 4
            },
            "wifi": {
              "type": "BSB_State.Wifi",
            ...
            "updateState": {
              "type": "BSB_Update.UpdateState",
              "id": 6
            },
            "updateCheck": {
              "type": "BSB_Update.CheckState",
              "id": 7
            },
            "timezone": {
              "type": "BSB_State.Timezone",
              "id": 8
            },
            "matter": {
              "type": "BSB_State.Matter",
              "id": 9
            },
            "frame": {
              "type": "BSB_Frame.Frame",
              "id": 10
            },
            "input": {
              "type": "BSB_Input.InputEvent",
              "id": 11
            },
            "timer": {
        ...
        "Brightness": {
          ...
          "fields": {
            "automatic": {
              "type": "BrightnessAutomatic",
              "id": 1
            },
            "manual": {
              "type": "BrightnessManual",
              "id": 2
            },
            "actualBrightness": {
              "type": "uint32",
        ...
        "Wifi": {
          ...
          "fields": {
            "unknown": {
              "type": "WifiStateUnknown",
              "id": 1
            },
            "inactive": {
              "type": "WifiStateInactive",
              "id": 2
            },
            "active": {
              "type": "WifiStateActive",
              "id": 3
            },
            "ipAddresses": {
              "rule": "repeated",
        ...
        "MatterCommissioningState": {
          "fields": {
            "status": {
              "type": "MatterCommissioningStatus",
              "id": 1
            },
            "timestamp": {
              "type": "fixed64",
